...
$string['staticshares_userhash'] = 'User hash (Unindentifiable identifier)';
...
$string['staticshares_pagetitle'] = 'Page title';
...
$string['privacy:metadata:liquidus:pagetitle'] = 'The page title (It is only shared with third parties if it is configured in the settings page).';
