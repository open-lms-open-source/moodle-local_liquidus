...
$string['privacy:metadata:liquidus:alluserroles'] = 'The alluserroles are obtained from all roles assigned to an user globally (It is only shared with third parties if it is configured in the settings page).';
